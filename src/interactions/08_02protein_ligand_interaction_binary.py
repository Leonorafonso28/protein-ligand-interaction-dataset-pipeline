...
input_dir = "data/interactions/interaction_details_csv_cif"
output_dir = "data/interactions/binary_interactions_csv"
os.makedirs(output_dir, exist_ok=True)


for csv_file in os.listdir(input_dir):
    if csv_file.endswith("_interactions.csv"):
        ...
        if interaction_summary['Interacting'].max() > 0:
            ...
            interaction_summary.to_csv(output_csv, index=False)
