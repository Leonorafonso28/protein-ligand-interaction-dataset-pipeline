...
#Directories
pdbbind_index = "data/raw/binding_affinity_external_dataset/INDEX_general_PL.2020R1.lst"
...
merged.to_csv("data/binding_affinity/filtered_df_with_PDBbind.csv", index=False)
print("File saved as data/binding_affinity/filtered_df_with_PDBbind.csv'")
