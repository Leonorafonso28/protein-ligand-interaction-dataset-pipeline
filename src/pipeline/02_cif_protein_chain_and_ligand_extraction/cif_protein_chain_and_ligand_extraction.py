...
def extract_atom_site_lines(cif_lines):
    ...
    for block in blocks:
        if any(line.startswith('_atom_site.') for line in block):
            ...
            # Filter only actual ATOM/HETATM lines (exclude metadata)
...
def preserve_spacing(original_line, updated_fields):
    ...
    # Detect if we converted HETATM → ATOM
...
def process_all_cifs(cif_dir, out_dir, fasta_dir, mapping_dir=None):
    ...
    df.to_csv("/Users/leonorafonso/Documents/Work/MoreiraLab/Project/Files/ligands_per_chain.csv", index=False)
    print("\n Done! ligands_per_chain.csv created.")
    return df

# Run
process_all_cifs("/Users/leonorafonso/Documents/Work/MoreiraLab/Project/Files/cif", "/Users/leonorafonso/Documents/Work/MoreiraLab/Project/Files/split_cif_chains", "/Users/leonorafonso/Documents/Work/MoreiraLab/Project/Files/fasta_sequences", "/Users/leonorafonso/Documents/Work/MoreiraLab/Project/Files/author_label_mappings")