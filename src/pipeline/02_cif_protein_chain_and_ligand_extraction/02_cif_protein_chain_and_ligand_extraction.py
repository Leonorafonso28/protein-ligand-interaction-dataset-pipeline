...
# Run
process_all_cifs("data/raw/cif_structures/cif", "data/interim/cif_structures/split_cif_chains", "data/interim/fasta/fasta_sequences", "data/interim/author_label_mappings")