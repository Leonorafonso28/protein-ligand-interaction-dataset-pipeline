...
chains_organisms_path = "data/interim/chain_organisms.csv"
protein_data_path = "data/interim/protein_data.csv"
organism_output_excel = "data/interim/chain_organisms_filtered.xlsx"
protein_output_excel = "data/interim/protein_data_filtered.xlsx"
...
lig_df.to_csv("data/interim/ligands_per_chain_filtered.csv", index=False)
