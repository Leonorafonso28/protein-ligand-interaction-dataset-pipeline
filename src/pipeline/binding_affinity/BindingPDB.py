...
uniprot_map = pd.read_csv("uniprot_mappings.csv")

#Reading BindingPDB file
bindingdb = pd.read_csv("BindingDB_All.tsv", sep="\t", low_memory=False)
...
#Save results
merged.to_csv("filtered_df_with_BindingDB.csv", index=False)
print("File saved as filtered_df_with_BindingDB.csv'")
