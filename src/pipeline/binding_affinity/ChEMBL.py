...
uniprot_data = pd.read_csv("/Users/leonorafonso/Documents/Work/MoreiraLab/Project/Files/uniprot_mappings.csv")
...
merged_data.to_csv("merged_data_filtered_ChEMBL_ID.csv", index=False)
...
act_df.to_csv("activities_data.csv", index=False)
...
ChEMBL_activities.to_csv("ChEMBL_activities.csv", index=False)
