...
# Load PDB IDs (only first 1000 for testing)
...
df_main.to_csv("data/interim/protein_data.csv", index=False)
...
pd.DataFrame(chain_rows, columns=["PDB_ID", "Chain_ID", "Organism"]).to_csv("data/interim/chain_organisms.csv", index=False)
